...
namespace AgroPack.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private AgroPackDbContext _DBEntity;

        public GenericRepository(AgroPackDbContext dbEntity)
        {
            _DBEntity = dbEntity;
        ...
        public IEnumerable<Tbl_Entity> GetRecordsToShow(int PageNo, int PageSize, int CurrentPage, Expression<Func<Tbl_Entity, bool>> wherePredict,
